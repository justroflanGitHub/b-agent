...
class PlanStep:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "dependencies": [{"step_id": d.step_id, "condition": d.condition} for d in self.dependencies],
...
class TaskPlan:
    ...
    def get_ready_steps(self) -> List[PlanStep]:
        ...
        return [step for step in self.steps if step.status == StepStatus.PENDING and step.is_ready(self.step_results)]
    ...
    def has_failed(self) -> bool:
        ...
        return any(step.status == StepStatus.FAILED and step.on_failure == "abort" for step in self.steps)
