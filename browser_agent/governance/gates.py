...
class ProductionURLGate(Gate):
    ...
    def __init__(self, patterns: List[str], approvers: List[str], priority: int = 100, tenant_id: Optional[str] = None):
...
class DestructiveActionGate(Gate):
    ...
    def __init__(self, approvers: List[str], priority: int = 90, tenant_id: Optional[str] = None):
        self._approvers = approvers
        self._priority = priority
        self._tenant_id = tenant_id
...
class FinancialTransactionGate(Gate):
    ...
    def __init__(self, approvers: List[str], priority: int = 95, tenant_id: Optional[str] = None):
        self._approvers = approvers
        self._priority = priority
        self._tenant_id = tenant_id
...
class ExternalSiteGate(Gate):
    ...
    def __init__(
        self, allowed_domains: List[str], approvers: List[str], priority: int = 70, tenant_id: Optional[str] = None
    ):
