    ...
    def check() -> ComponentHealth:
        try:
            ...
            if hasattr(browser_controller, 'is_connected'):
                ...
                connected = browser_controller._browser is not None if hasattr(browser_controller, '_browser') else False
        ...
        try:
            ...
            if ready:
                return ComponentHealth(
                    name="vision",
                    status=HealthStatus.HEALTHY,
                    message="Vision model ready"
                )
            else:
                return ComponentHealth(
                    name="vision",
                    status=HealthStatus.UNHEALTHY,
                    message="Vision model not ready"
                )
        except Exception as e:
            return ComponentHealth(
                name="vision",
