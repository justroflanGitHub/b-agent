...
class BrowserState:
    ...
    def matches(self, other: "BrowserState", ignore_timestamp: bool = True) -> bool:
        ...
        if ignore_timestamp:
            return (
                self.url == other.url
                and self.scroll_x == other.scroll_x
                and self.scroll_y == other.scroll_y
                and self.screenshot_hash == other.screenshot_hash
            )
...
class CheckpointManager:
    ...
    def _load_from_disk(self) -> None:
        ...
        try:
            ...
            self._checkpoint_order.sort(key=lambda cid: self._checkpoints[cid].created_at)
    ...
    def get_task_checkpoints(self) -> List[Checkpoint]:
        ...
        return [self._checkpoints[cid] for cid in self._current_task_checkpoints if cid in self._checkpoints]
