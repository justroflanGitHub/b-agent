        ...
        **kwargs
        ...
        try:
            ...
            result = await self.vision_client.get_click_coordinates(
                ...
                instruction=f"Find: {description}"
            )
...
class FallbackManager:
    ...
    async def execute_fallback(
        ...
        **kwargs
        ...
        # Check attempt limit
        attempt_key = f"{strategy.name}_{error_context.error_type.value}"
        attempt_count = sum(
            1 for r in self._fallback_history
